...
class Dimensions{
  ...
  static double radius12 = screenHeight/102;
  static double radius20 = screenHeight/20.8;
  static double radius24 = screenHeight/34;
  static double radius30 = screenHeight/27.2;


  //dynamic text size
  static double textSize10 = screenHeight/81.6;
  ...
  static double iconSize18 = screenHeight/45.33;
}